...
namespace BookingApplication.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        public async Task<IActionResult> BookNow(Guid? id)
        {
            if (id == null)
            {
                return NotFound();
        ...
        // POST: Reservations/BookNow/5
        [HttpPost, ActionName("BookApartment")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> BookApartment(Guid ReservationId, int numberOfNights)
        {
            ...
            var bookReservation = new BookReservation
            {
                ...
                BookingList = _context.BookingLists.FirstOrDefault(b => b.UserId == userId),
                UserId = userId
            };
